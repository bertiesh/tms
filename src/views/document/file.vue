 ...
 v-if="scope.row.collectionCover"
  ...
  lazy
      ...
      @click="magnify(scope.row.collectionCover)"></el-image>
            ...
            <el-table-column prop="fileCount" label="文件数目">
            </el-table-column>
        ...
        <el-dialog :title="isadd ? '添加' : '编辑'" :visible.sync="userform">
          <el-form
            ...
            ref="userform"
          >
            <el-form-item label="文档名称" prop="collectionName">
              <el-input
                v-model="rowdata.collectionName"
                placeholder="请输入文档名称"
              ></el-input>
            </el-form-item>
            <el-form-item label="文档描述" prop="collectionDesc">
              <el-input
  ...
  <el-input v-if="rowdata.status!=1" v-model="rowdata.status" placeholder="请输入内容"></el-input>
            </el-form-item>
            <el-form-item label="文档封面" prop="collectionCover">
              <el-upload
              ref="upload"
  ...
  <i class="el-icon-plus" v-if="isadd"></i>
            ...
            <el-form-item label="文档类型" v-show="false">
                {{rowdata.type=1}}
            </el-form-item>
          </el-form>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      isadd: true,
formrules: {
        collectionName: [{ required: true, message: "请输入文档名称", trigger: "blur" }],
        collectionDesc: [{ required: true, message: "请输入文档描述", trigger: "blur" }],
        status: [
...
// 进入文件管理页面
    openfile(list){
this.$router.push({ path: '/document/filelist',query:{id:list.id} });
    },
    // 进入加载
    onLoad() {
      const data = {
